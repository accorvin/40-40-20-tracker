/**
 * Tests for TeamDetail.vue component - following TDD practices.
 */
...
import BucketBreakdown from '../components/BucketBreakdown.vue'
import UnestimatedPanel from '../components/UnestimatedPanel.vue'
...
describe('TeamDetail', () => {
  ...
  it('shows sprint date range', () => {
    const wrapper = mount(TeamDetail, { props: defaultProps })
    // Dates are formatted with toLocaleDateString, verify the range separator and month
  ...
  it('renders UnestimatedPanel with unestimated issues', () => {
    ...
    // Should have 2 unestimated issues (RHOAIENG-3 and RHOAIENG-7)
