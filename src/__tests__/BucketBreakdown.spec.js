/**
 * Tests for BucketBreakdown.vue component - following TDD practices.
 */
...
describe('BucketBreakdown', () => {
  const defaultProps = {
    ...
    issues: [
      ...
      {
        key: 'RHOAIENG-101',
        summary: 'Resolve timeout errors',
        url: 'https://issues.redhat.com/browse/RHOAIENG-101',
        storyPoints: 3,
        status: 'In Progress',
        completed: false
      }
