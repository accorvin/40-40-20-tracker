/**
 * Tests for TeamCard.vue component - following TDD practices.
 */
...
describe('TeamCard', () => {
  const mockBoard = {
    id: 1,
    name: 'RHOAIENG Board - Team Alpha',
  ...
  it('displays team name from displayName', () => {
    const wrapper = mount(TeamCard, {
      props: { board: mockBoard, sprintData: mockSprintData }
    })
  ...
  it('falls back to board name when no displayName', () => {
    ...
    const wrapper = mount(TeamCard, {
      props: { board: boardNoDisplay, sprintData: mockSprintData }
    })
  ...
  it('shows "No sprint data" when sprintData is null', () => {
    const wrapper = mount(TeamCard, {
      props: { board: mockBoard, sprintData: null }
    })
  ...
  it('shows completion percentage for closed sprints', () => {
    ...
    const wrapper = mount(TeamCard, {
      props: { board: mockBoard, sprintData: closedSprintData }
    })
