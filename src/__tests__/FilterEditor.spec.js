/**
 * Tests for FilterEditor.vue component - following TDD practices.
 */
...
describe('FilterEditor', () => {
  ...
  describe('create mode (filter=null)', () => {
    ...
    it('renders checkboxes for each board, all unchecked', () => {
      ...
      const checkboxes = wrapper.findAll('input[type="checkbox"]').filter(
        cb => !cb.element.dataset.testid?.startsWith('select-')
      )
      // Filter out select-all/deselect-all - get board checkboxes
