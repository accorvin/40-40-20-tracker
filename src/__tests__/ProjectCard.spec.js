...
describe('ProjectCard', () => {
  ...
  it('displays project name', () => {
    const wrapper = mount(ProjectCard, {
      props: { project: mockProject, summary: mockSummary }
    })
  ...
  it('shows "No data available" when summary is null', () => {
    const wrapper = mount(ProjectCard, {
      props: { project: mockProject, summary: null }
    })
  ...
  it('handles singular board count', () => {
    ...
    const wrapper = mount(ProjectCard, {
      props: { project: mockProject, summary: singleBoardSummary }
    })
