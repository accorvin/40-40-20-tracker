/**
 * Tests for FilterSelector.vue component - following TDD practices.
 */
...
describe('FilterSelector', () => {
  ...
  it('does not show dropdown by default', () => {
    wrapper = mountComponent({ filters: mockFilters })
  ...
  it('highlights "All Teams" when no filter is active', async () => {
    wrapper = mountComponent({ filters: mockFilters, activeFilterId: null })
  ...
  it('highlights active filter in dropdown', async () => {
    wrapper = mountComponent({ filters: mockFilters, activeFilterId: 'abc123' })
